...
export const metadata: Metadata = {
  title: "Professional Portfolio - Design & Strategy",
  description: "Explore my portfolio showcasing strategic design work, brand development, and user experience solutions for leading brands.",
  keywords: ["portfolio", "design", "UX", "brand strategy", "digital design", "creative services"],
  ...
  openGraph: {
    title: "Professional Portfolio - Design & Strategy",
    description: "Explore my portfolio showcasing strategic design work, brand development, and user experience solutions.",
    type: "website",
    siteName: "Portfolio",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1766099563969-68on6e0t.jpg",
  ...
  twitter: {
    ...
    title: "Professional Portfolio - Design & Strategy",
    description: "Strategic design solutions and creative excellence",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1766099563969-68on6e0t.jpg"]
  },
  robots: {
    index: true,
    follow: true
